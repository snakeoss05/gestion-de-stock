      ...
      <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
        <CardHeader className="bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-t-lg">
          ...
          <CardDescription className="text-orange-100">
            Conditions de paiement et limites
          </CardDescription>
        </CardHeader>
        <CardContent className="p-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  handleInputChange("conditionsPaiement", value)
                }>
                <SelectTrigger>
            ...
            <div className="space-y-2">
              <Label htmlFor="limiteCredit">Limite de Crédit (TND )</Label>
              <Input
                id="limiteCredit"
                type="number"
                placeholder="0"
                ...
                onChange={(e) =>
                  handleInputChange("limiteCredit", e.target.value)
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("remiseAccordee", e.target.value)
                }
              />
            </div>
          </div>
