            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Badge className={getTypeColor(client.typeClient)}>
                  {client.typeClient.charAt(0).toUpperCase() +
                    client.typeClient.slice(1)}
                </Badge>
              </div>
              <div>
                <p className="text-sm text-gray-500">Statut</p>
                <Badge className={getStatusColor(client.statut)}>
                  {client.statut.charAt(0).toUpperCase() +
                    client.statut.slice(1)}
                </Badge>
              </div>
            </div>
            <div>
