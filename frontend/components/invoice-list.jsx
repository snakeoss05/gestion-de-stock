...
import { Eye, Edit, Trash2, Search, TrendingUp, ShoppingCart } from "lucide-react"
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="border-b bg-gray-50">
              ...
              <th className="text-left p-4 font-semibold">Client/Fournisseur</th>
          ...
          <tbody>
            {filteredInvoices.map((invoice) => (
              <tr key={invoice.id} className="border-b hover:bg-gray-50 transition-colors">
                <td className="p-4 font-mono font-semibold text-blue-600">{invoice.id}</td>
                <td className="p-4">
                ...
                <td className="p-4 text-gray-600">{formatDate(invoice.invoiceDate)}</td>
                ...
                <td className="p-4">
                  <div className="flex gap-2">
                    <Button size="sm" variant="outline" onClick={() => onView(invoice)} title="Voir la Facture">
                      <Eye className="h-4 w-4" />
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => onEdit(invoice)} title="Modifier la Facture">
