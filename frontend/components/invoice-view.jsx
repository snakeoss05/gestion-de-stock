...
import { Edit, Trash2, Download, Mail, PrinterIcon as Print, TrendingUp, ShoppingCart } from "lucide-react"
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Voir et gérer les détails de la facture</p>
        </div>
        ...
        <CardContent className="p-8">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              ...
              <div className="mt-2">
                <Badge className={`${getTypeColor(invoice.type || "vente")} text-sm px-3 py-1`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <h3 className="text-lg font-semibold mb-3 text-gray-700">{invoice.type === "vente" ? "De:" : "À:"}</h3>
          ...
          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4 text-gray-700">Articles</h3>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-200">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="border border-gray-200 p-3 text-left">Description</th>
                    <th className="border border-gray-200 p-3 text-center">Quantité</th>
                    <th className="border border-gray-200 p-3 text-right">Prix Unitaire</th>
                ...
                <tbody>
                  {invoice.items.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="border border-gray-200 p-3 text-right font-semibold">{item.total.toFixed(2)} €</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="text-center text-sm text-gray-500 border-t pt-4">
            ...
            <p>Pour toute question concernant cette facture, contactez-nous à contact@votreentreprise.com</p>
          </div>
        </CardContent>
      </Card>
    </div>
